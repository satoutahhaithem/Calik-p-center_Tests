...
print ("max-sat_instance/"+filename)
output_dir = os.path.dirname("./max-sat_instance/instance" + instName)
if not os.path.exists(output_dir):
    os.makedirs(output_dir)

constraints.to_file("./max-sat_instance/" + instName)
